  ...
  <b-container fluid>
    <b-row>
      <b-col cols="6" class="pl-5">
        ...
        <p id="art1">
          Nous utilisons publications scientifique
          <br />et données publiques pour vous proposer
          <br />des contenus ludiques, éducatifs et
          <br />vous donner les clés de votre santé.
        </p>
